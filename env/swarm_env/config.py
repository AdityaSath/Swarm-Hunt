...
REWARD_VISIBLE_ALIGNMENT = 0.008
PENALTY_VISIBLE_MISALIGNMENT = -0.004
REWARD_CAPTURE_RANGE_STEP = 0.012
...
DIST_SHAPING_SCALE = 12.0          # multiplier for normalized predator-prey progress
DIST_SHAPING_CLIP = 0.05           # per-step distance-shaping clipped to [-clip, +clip]
